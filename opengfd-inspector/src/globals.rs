...
use opengfd :: { device :: ngr :: { allocator :: Allocator , renderer :: { platform :: d3d :: { ngr_142ed6270 , ngrDX11Renderer } , state :: DrawState } , structures :: { ListNodeFreeList , PointerListEntry } } , io :: keyboard :: Keyboard , kernel :: { global :: Global , job :: Job } , tpl :: file_manager :: FileManager , } ;
