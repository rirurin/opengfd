    ...
    where TProjectManager: ProjectManagerBase
{
    ...
    public ExecutorBase(string[] args, string PackageFolder)
    {
        RootPath = args[0];
        var pargs = args[1..];
        ...
        Watch = new Stopwatch();
        PublishState = new(RootPath, PackageFolder, ArgList["Publish"].Enabled);
    }
    public void PrintInformation()
    {
        Console.WriteLine($"{new ColorRGB(78, 207, 147)}OpenGFD Build Script{new ClearFormat()}");
